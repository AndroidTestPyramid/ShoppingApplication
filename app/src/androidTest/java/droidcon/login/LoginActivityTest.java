...
public class LoginActivityTest {
  ...
  @Ignore
  public void shouldDisplayErrorOnExceptionFromServer() {
...
//    mockWebServerRule.mockResponseWithException(url, APIClient.RequestType.GET.name(), new Exception());

    onView(withId(R.id.sign_in_button)).perform(ViewActions.click());

    onView(withText(R.string.technical_difficulty)).inRoot(withDecorView(ViewMatchers.withChild(ViewMatchers.withText(R.string.invalid_credential)))).check(matches(isDisplayed()));
  }
